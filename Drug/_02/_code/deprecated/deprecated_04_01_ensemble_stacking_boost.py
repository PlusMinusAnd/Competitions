...
models = {
    "lgbm": LGBMRegressor(n_estimators=1000, **param_lgbm),
    "xgb": XGBRegressor(n_estimators=1000, **param_xgb),
    "cat": CatBoostRegressor(iterations=1000, **param_cat)
}
...
submission.to_csv("./Drug/_02/3_submission/submission_stack_boost.csv", index=False)
print("✅ submission_stack_boost.csv 저장 완료")
